...
import FilteredKeywordList, { getFilteredKeywords } from '@/components/FilteredKeywordList';
...
export default function Home() {
  ...
  const getTopKeywordsText = (keywords: Record<string, number>): string => {
    const filtered = getFilteredKeywords(keywords);
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <span style={{ fontWeight: 'bold', color: '#444', whiteSpace: 'nowrap' }}>제목:</span>
              <div
                style={{
                  flex: 1,
                  padding: '15px 20px',
